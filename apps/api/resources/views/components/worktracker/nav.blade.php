<nav class="wt-nav-shell" aria-label="منوی WorkTracker">
 <a class="wt-brand" href="{{ route('worktracker.dashboard') }}"><span class="wt-brand-mark">W</span><span><strong>WorkTracker</strong><small>مدیریت زمان، پروژه و صورتحساب</small></span></a>
