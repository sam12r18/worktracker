...
class SyncController extends Controller
{
    ...
    private function validateEntityPayload(string $entity, string $entityId, array $payload, int|string $userId, string $deviceId): array
    {
        ...
        $validated = Validator::make($payload, [
            ...
            'ide_context' => ['nullable','array'],
            'ide_context.protocol_version' => ['nullable','integer','min:1','max:10'],
            'ide_context.plugin_version' => ['nullable','string','max:64'],
            'ide_context.ide_product' => ['nullable','string','max:128'],
            'ide_context.ide_build' => ['nullable','string','max:64'],
            'ide_context.process_id' => ['nullable','integer','min:1'],
            'ide_context.project_name' => ['nullable','string','max:255'],
            'ide_context.project_path' => ['nullable','string','max:4096'],
            'ide_context.current_file' => ['nullable','string','max:1024'],
            'ide_context.current_file_path' => ['nullable','string','max:4096'],
            'ide_context.git_branch' => ['nullable','string','max:512'],
            'ide_context.execution_mode' => ['nullable','in:idle,run,debug,test'],
            'ide_context.run_configuration' => ['nullable','string','max:1024'],
            'ide_context.run_configuration_type' => ['nullable','string','max:512'],
            'ide_context.observed_at_utc' => ['nullable','date'],
            'ide_context.source' => ['nullable','string','max:64'],
