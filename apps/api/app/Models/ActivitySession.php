...
class ActivitySession extends Model
{
    ...
    protected $fillable=['device_id','project_id','activity_type_id','activity_type_confidence','activity_type_source','activity_type_reason','ide_context','browser_context','is_billable','task_id','source','process_name','executable_path','window_title','classification_confidence','classification_reason','started_at','ended_at','duration_seconds','idle_seconds','note','version','created_at_device','updated_at_device'];
    protected $casts=['started_at'=>'datetime','ended_at'=>'datetime','created_at_device'=>'datetime','updated_at_device'=>'datetime','is_billable'=>'boolean','classification_confidence'=>'float','activity_type_confidence'=>'float','ide_context'=>'array','browser_context'=>'array','version'=>'integer'];
