...
public partial class App : System.Windows.Application
{
    ...
    protected override async void OnStartup(StartupEventArgs e)
    {
        ...
        try
        {
            ...
            var repository=new ActivitySessionRepository(database);var projects=new ProjectRepository(database);var activityTypes=new ActivityTypeRepository(database);var classifier=new ProjectClassificationService(projects);var corrections=new ActivityCorrectionService(repository,classifier);
